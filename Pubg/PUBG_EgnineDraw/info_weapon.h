...
static tWeaponInfo GetWeaponInfo(unsigned Hash) {
	...
	switch (Hash) {
		//Throw
		HASH_CASE("WeapFlashBang_C"h, { "ÉÁ¹âµ¯"e, tWeaponType::Throw });
		HASH_CASE("WeapGrenade_C"h, { "ÊÖÀ×"e, tWeaponType::Throw });
		HASH_CASE("WeapStickyGrenade_C"h, { "Õ³ÐÔÕ¨µ¯"e, tWeaponType::Throw });
		HASH_CASE("WeapMolotov_C"h, { "È¼ÉÕÆ¿"e, tWeaponType::Throw });
		HASH_CASE("WeapSmokeBomb_C"h, { "ÑÌÎíµ¯"e, tWeaponType::Throw });
		HASH_CASE("WeapC4_C"h, { "C4"e, tWeaponType::Throw });
		HASH_CASE("WeapDecoyGrenade_C"h, { "ÓÕ¶üÊÖÀ×"e, tWeaponType::Throw });
		HASH_CASE("WeapBluezoneGrenade_C"h, { "¶¾È¦ÊÖÀ×"e, tWeaponType::Throw });
		HASH_CASE("WeapSpikeTrap_C"h, { "¼â´ÌÏÝÚå"e, tWeaponType::Throw });

		//Melee
		HASH_CASE("WeapCowbar_C"h, { "ÇË¹÷"e, tWeaponType::Melee });
		HASH_CASE("WeapPan_C"h, { "Æ½µ×¹ø"e, tWeaponType::Melee });
		HASH_CASE("WeapSickle_C"h, { "Á­µ¶"e, tWeaponType::Melee });
		HASH_CASE("WeapMachete_C"h, { "¿³µ¶"e, tWeaponType::Melee });
		HASH_CASE("WeapCowbarProjectile_C"h, { "ÇË¹÷"e, tWeaponType::Throw });
		HASH_CASE("WeapMacheteProjectile_C"h, { "Machete"e, tWeaponType::Throw });
		HASH_CASE("WeapPanProjectile_C"h, { "Æ½µ×¹ø"e, tWeaponType::Throw });
		HASH_CASE("WeapSickleProjectile_C"h, { "Á­µ¶"e, tWeaponType::Throw });

		//AR
		HASH_CASE("WeapLunchmeatsAK47_C"h, { "AKM"e, tWeaponType::AR });
		HASH_CASE("WeapAK47_C"h, { "AK,"e, tWeaponType::AR });
		HASH_CASE("WeapGroza_C"h, { "¹·ÔÒ"e, tWeaponType::AR });
		...
		HASH_CASE("WeapMosinNagant_C"h, { "ÄªÐÁ¸ÊÄÉ"e, tWeaponType::SR });
		HASH_CASE("WeapCrossbow_1_C"h, { "åó"e, tWeaponType::SR, ZeroingCBow });
		...
		HASH_CASE("WeapSawnoff_C"h, { "¾â³ÝÊÖÇ¹"e, tWeaponType::SG, ZeroingSG });
		...
		//SMG
		HASH_CASE("WeapThompson_C"h, { "ÌÀÄ·Ñ·"e, tWeaponType::SMG });
		...
		HASH_CASE("WeapBizonPP19_C"h, { "Ò°Å£PP19"e, tWeaponType::SMG });
		...
		HASH_CASE("WeapFlareGun_C"h, { "ÐÅºÅÇ¹"e });
		HASH_CASE("WeapPanzerFaust100M1_C"h, { "»ð¼ýÍ²"e });
		HASH_CASE("WeapJerryCan_C"h, { "ÆûÓÍÍ°"e });
		HASH_CASE("WeapDrone_C"h, { "ÎÞÈË»ú"e });
		HASH_CASE("WeapTraumaBag_C"h, { "Ò½ÁÆÌ×¼þ"e });
		HASH_CASE("WeapSpotterScope_C"h, { "ÍûÔ¶¾µ"e });
		HASH_CASE("WeapTacPack_C"h, { "Õ½Êõ±³°ü"e });
